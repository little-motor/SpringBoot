...
document.writeln("            <a class=\'navbar-brand\' href=\'http://www.littlemotor.cn\'>Little Motor</a>");
...
document.writeln("                <li><a href=\'/community\'>社区</a></li>");
document.writeln("                <li><a href=\'/user/message\'>我的留言</a></li>");
// document.writeln("                <li><a href=\'#\'>介绍</a></li>");
document.writeln("            </ul>");
document.writeln("");
document.writeln("            <!--根据是否登陆显示不同效果-->");
document.writeln("            <ul class=\'nav navbar-nav navbar-right\'>");
document.writeln("                <li class=\'logout\'><a href=\'http://www.littlemotor.cn\'>注册</a></li>");
...
document.writeln("                            <a role=\'menuitem\' href=\'/user/message\'>我的留言</a>");
document.writeln("                        </li>");
document.writeln("                        <li role=\'presentation\'>");
document.writeln("                            <a role=\'menuitem\' href=\'/user/page\'>设置</a>");
document.writeln("                        </li>");
// document.writeln("                        <li role=\'presentation\'>");
