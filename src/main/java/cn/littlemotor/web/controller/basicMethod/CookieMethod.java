package cn.littlemotor.web.controller.basicMethod;
...
public class CookieMethod {
    ...
    public CookieMethod(HttpServletRequest httpServletRequest){
    ...
    public List<Cookie> getCookieList(){
        ...
        try {
            ...
            this.loginCookie = new Cookie("login", "false");
            cookieList.add(loginCookie);
            //System.out.println("CookieMethod has some wrong");
        } finally {
           return cookieList;
        }
    }
